...
const ProductNotFound = () => {
  return (
    <div className="product-not-found flex flex-col items-center justify-center">
      ...
      <h3 className="text-[#25282B] text-4xl font-bold text-center">
        No Products Found{" "}
      </h3>
      <p className="text-[#25282B] text-center text-[20px] font-normal leading-10 mt-4">{`Sorry, we couldn't find any products matching your search. Please check your spelling or try a different keyword.`}</p>
      <div className="container mx-auto h-[1px] w-full bg-[#DADADA] mt-4"></div>
      <h1 className="font-bold text-[25px] flex flex-row items-center justify-center space-x-2 mt-11">
