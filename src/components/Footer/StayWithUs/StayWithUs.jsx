const StayWithUs = () => {
	return (
		<div
			...
			className="stay-with-us-wrapper w-full lg:px-amulette mt-[50px] lg:mt-[74px] py-8 lg:pb-16"
		>
			<div className="stay-with-us max-w-amulette sm:w--[80%] w--[95%]  mx-auto flex flex-col lg:flex-row items-center justify-center lg:justify-between bg-[#FFEFE8] rounded-2xl px-5 lg:px--16 py-8 lg:py-14">
