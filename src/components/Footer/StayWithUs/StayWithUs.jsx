		...
		>
			<div className="stay-with-us lg:container mx-auto flex flex-col lg:flex-row items-center justify-center lg:justify-between bg-[#FFEFE8] rounded-2xl px-5 lg:px-16 py-8 lg:py-14">
				<div className="col-left flex flex-col items-center justify-center">
					...
					<p className="text-[#1B1B1B] font-Poppins text-sm lg:text-lg font-normal mt-3 pl-2">
				...
				<div className="col-right w-full">
					<div className="email-subscribe  flex flex-row items-center justify-center space-x-3 p-2.5">
						...
						/>
						<button className=" w-[104px]  py-3  font-medium text-white border border-primaryColor bg-primaryColor sm:text-base text-sm rounded-lg">
							Continue
						</button>
					</div>
				</div>
